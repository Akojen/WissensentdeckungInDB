...
```{r}
new.data = data.frame(
  Geschlecht    = c(0.538,1), 
  Alter         = c(0.089),
  Raucherstatus = c(18.146, 1),
  Ausbildung    = c(0.748, 1)
)
raucher = new.data[2, "Geschlecht"] * 63 * new.data[1, "Alter"] * new.data[1, "Raucherstatus"] * new.data[2, "Ausbildung"]
nichtraucherin = new.data[1, "Geschlecht"] * 63 * new.data[1, "Alter"] * new.data[2, "Raucherstatus"] * new.data[1, "Ausbildung"]
 
raucher 
nichtraucherin
```
Interpretation: Das Risiko für den 63jährigen Raucher ist etwa 50 mal so hoch an Lungenkrebs zu sterben, wie für die 63jährige Nicht-Raucherin.
