...
train.mylda <- function(data, target) {
  ...
  realCovSum <- matrix(0, ncol=p, nrow=p)
  ...
  for (i in 1: length(classes)) {
    ...
    realCovSum <- realCovSum+cov(cleanClassSpecificData)
  }
  ...
  print(covMat)
  print(realCovSum) # zum vergleich mit cov berechnet, kann wieder raus
  print(abs(covMat-realCovSum)) # differenz zu R cov
}
train.mylda(iris, "Species")
```
