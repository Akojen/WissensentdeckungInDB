...
```{r}
C_s = function(k) {
  (aprioriS*dbinom(x=k, size=4, p=0.5)*costs[1,1] + aprioriUG*geoVerteiling*costs[1,2])
}
C_ug = function(k) {
  (aprioriS*dbinom(x=k, size=4, p=0.5)*costs[2,1] + aprioriUG*geoVerteiling*costs[2,2])
}
