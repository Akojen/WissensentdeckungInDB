...
p_schmack = pbinom(1, size=4, prob=0.5) ##dbinom gives the density, pbinom gives the distribution function, qbinom gives the quantile function and rbinom generates random deviates.
p_unschmack = pgeom(3, prob = 0.3)

print(p_schmack)
print(p_unschmack)

##Kann nicht sein.. da Summe != 1
```
