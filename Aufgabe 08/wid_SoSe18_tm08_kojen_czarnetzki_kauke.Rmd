...
#-> Klassenvorhersage für jede Beobachtung (des Testdatensatzes):
...
print("Im Gegensatz zur Methode mit kombinierten Einzelbäumen, bei der die Klassen in 40% der Fälle falsche vorhergesagt wurden, gelingt mit randomForest eine perfekte Klassenvorhersage!!!")
```
