...
author: "Sebastian Buschjäger, Malte Jastrow"  # Alexander Kojen
output: pdf_document
---
...
Varianz
$$
\mathrm{Var}(X) = (1-\frac{1}{2})^2*\frac{1}{2} + (0-\frac{1}{2})^2*\frac{1}{2} = \frac{1}{8} + \frac{1}{8} = \frac{1}{4}
$$
Die Zufallsvariable ist gleich- oder binomialverteilt.
...
$$
Die Summe ist binomialverteilt.
